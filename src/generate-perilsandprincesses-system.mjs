...
class SystemGenerator {
   ...
   *
   * Replace refercnes to 'boilerplate', 'PerilsAndPrincesses', and 'PERILSANDPRINCESSES'
...
inquirer
  ...
  .then((answers) => {
    ...
    // Glob PerilsAndPrincesses's files so that we can process them.
