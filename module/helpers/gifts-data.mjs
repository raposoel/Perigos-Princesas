/**
 * Dados centralizados de todos os Dons (Fada Madrinha) do sistema Perigos & Princesas.
 *
 * Este arquivo foi extraído de `actor-sheet.mjs` (onde o objeto `giftData` vivia
 * embutido dentro de `getData()`) para poder ser reaproveitado tanto pela ficha
 * quanto pela nova tela de Criação de Princesa (`module/apps/princess-creation.mjs`).
 *
 * IMPORTANTE: dos 11 Dons que já aparecem como opção na ficha, apenas 4 têm todo o
 * conteúdo de regras (descrição, talentos, habilidades inatas/especiais e mishaps)
 * escrito até agora: Sabedoria do Pântano, Coração Selvagem, Voz Encantadora e
 * Presença Régia. Os outros 7 ficam aqui só com título + imagem (stub), prontos
 * para receber o conteúdo completo quando você escrever essas regras — a tela de
 * criação e a ficha já tratam esse caso (mostram só a imagem/título, sem quebrar).
 */
export const GIFTS_DATA = {
	bogwis: {
		title: "Sabedoria do Pântano",
		img: "systems/perigoseprincesas/assets/dons/sabedoria_do_pantano.webp",
		description:
	...
	wildheart: {
		...
		img: "systems/perigoseprincesas/assets/dons/coracao_selvagem.webp",
		description:
	...
	title: "Voz Encantadora",
		img: "systems/perigoseprincesas/assets/dons/voz_encantadora.webp",
	description:
...
glimaura: {
	...
	regpres: {
		...
		img: "systems/perigoseprincesas/assets/dons/presenca_regia.webp",
		description:
	...
	// --- Dons ainda sem conteúdo de regras escrito no sistema (só título + imagem) ---
	spriteag: {
		title: "Agilidade Feérica",
		img: "systems/perigoseprincesas/assets/dons/agilidade_feerica.webp",
	},
	powfriend: {
		title: "Amizade Poderosa",
		img: "systems/perigoseprincesas/assets/dons/amizade_poderosa.webp",
	},
	glimaura: {
		title: "Aura Cintilante",
		img: "systems/perigoseprincesas/assets/dons/aura_cintilante.webp",
	},
	elementcon: {
		title: "Conexão Elemental",
		img: "systems/perigoseprincesas/assets/dons/conexao_elemental.webp",
	},
	kitchmag: {
		title: "Magia da Cozinha",
		img: "systems/perigoseprincesas/assets/dons/magia_da_cozinha.webp",
	},
	sageint: {
		title: "Sábio Intelecto",
		img: "systems/perigoseprincesas/assets/dons/sabio_intelecto.webp",
	},
	healtouch: {
		title: "Toque Curativo",
		img: "systems/perigoseprincesas/assets/dons/toque_curativo.webp",
	},
};

/**
 * Ordem de exibição dos Dons na grade de escolha da tela de Criação de Princesa.
 * (Mesma ordem alfabética já usada no dropdown antigo da ficha.)
 */
...
/**
 * Rótulos amigáveis usados no dropdown legado (mantido por compatibilidade e
 * usado como fallback caso algum título mude em GIFTS_DATA).
 */
